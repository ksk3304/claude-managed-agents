...
export async function handleGoogleChatWebhook(
  ...
  // Google Chat needs a visible async response before the slow CMA turn
  // finishes. Post a short placeholder now; the Queue consumer later PATCHes
  // the same message with the final answer.
