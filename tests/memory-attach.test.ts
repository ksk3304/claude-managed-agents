...
describe('Memory Store router (Issue #246)', () => {
  const attachments = [
    ...
    { memory_store_id: 'mem_company', access: 'read_only' as const, store_name: 'company_core_memory' },
    { memory_store_id: 'mem_agent_identity', access: 'read_write' as const, store_name: 'Makoto Prime_0001_identity_memory' },
    { memory_store_id: 'mem_agent_support', access: 'read_write' as const, store_name: 'Makoto Prime_0001_support_memory' },
    { memory_store_id: 'mem_agent_daily', access: 'read_write' as const, store_name: 'Makoto Prime_0001_daily_report_store' },
    { memory_store_id: 'mem_agent_log', access: 'read_write' as const, store_name: 'Makoto Prime_0001_session_log_store' },
    { memory_store_id: 'mem_dm_log', access: 'read_write' as const, store_name: 'session_log_dm_store' },
    { memory_store_id: 'mem_dm_report', access: 'read_write' as const, store_name: 'daily_report_dm_store' },
