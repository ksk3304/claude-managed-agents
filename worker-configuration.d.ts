/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 61388e1c613290d972e108cc2502cf06)
// Runtime types generated with workerd@1.20260507.1 2026-05-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ThreadLock" | "OAuthLease";
	}
	interface StagingEnv {
		...
		MAKOTO_THREAD_LOCK: DurableObjectNamespace<import("./src/index").ThreadLock>;
		MAKOTO_OAUTH_LEASE: DurableObjectNamespace<import("./src/index").OAuthLease>;
	}
	interface Env {
		MAKOTO_KV: KVNamespace;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAKOTO_CHAT_QUEUE_NAME" | "MAKOTO_EXTERNAL_SIDE_EFFECTS_DISABLED" | "WEBHOOK_SECRET_AGENTMAIL_PRIMARY">> {}
}
